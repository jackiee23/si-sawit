                ...
                <form method="POST" action="/dashboard/farm/{{ $farm->id }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_kebun') is-invalid @enderror" id="inputnama"
                            name="nama_kebun" placeholder="Masukkan Nama Petani"
                            value="{{ old('nama_kebun', $farm->nama_kebun) }} ">
                        @error('nama_kebun')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('luas') is-invalid @enderror" id="luas"
                            name="luas" value="{{ old('luas', $farm->luas) }} " placeholder="Masukkan Luas Kebun">
                        @error('luas')
                            <div class="invalid-feedback">
                                Tidak boleh di kosongkan.
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('jarak') is-invalid @enderror" id="jarak"
                            name="jarak" value="{{ old('jarak', $farm->jarak) }} " placeholder="Masukkan Jarak">
                        @error('jarak')
                            <div class="invalid-feedback">
                                Tidak boleh di kosongkan.
                            </div>
