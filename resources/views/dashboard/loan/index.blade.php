    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                ...
                <a href="/loan/create" class="btn btn-info">Tambah Data</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/loan/{{$loan->id}}/edit/"><i class="fas fa-edit text-success"></i></a>
                                    <form id="formHapus" action="/loan/{{ $loan->id }} " method="post" class="d-inline">
                                        @method('delete')
                                        @csrf
