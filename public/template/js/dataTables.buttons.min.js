...
!(function (e) {
    ...
    v.extend(k.prototype, {
        ...
        add: function (t, n, e) {
            ...
            return (
                this._expandButton(
                    ...
                    t,
                    t !== x ? t.split : x,
                    (t === x || t.split === x || 0 === t.split.length) &&
                        s !== x,
                    !1,
                    n
                ),
        ...
        node: function (t) {
            return t
                ? ((t = this._nodeToButton(t)), v(t.node))
                : this.dom.container;
        },
        ...
        remove: function (t) {
            ...
            (n.conf.destroying = !0),
                n.conf.destroy &&
                    n.conf.destroy.call(o.button(t), o, v(t), n.conf),
        ...
        text: function (t, n) {
            ...
            var o = this._nodeToButton(t),
                ...
                t = (o.inCollection && t && t.tag ? t : this.c.dom.buttonLiner)
                    .tag,
                i = this.s.dt,
                s = v(o.node);
            return n === x
                ...
                : ((o.conf.text = n),
                  (t
                      ? s.children(t).eq(0).filter(":not(.dt-down-arrow)")
                      : s
                  ).html(e(n)),
                  this);
        },
        ...
        _addKey: function (t) {
            t.key &&
                (this.s.listenKeys += (v.isPlainObject(t.key) ? t.key : t).key);
        },
        _draw: function (t, n) {
        ...
        _buildButton: function (n, t, e, o) {
            ...
            if (n.spacer)
                return (
                    (r = v("<span></span>")
                        .addClass(
                            "dt-button-spacer " + n.style + " " + u.spacerClass
                        )
                        .html(i(n.text))),
                    {
                        conf: n,
            ...
            n.hasOwnProperty("html")
                ...
                : ((s = function (t, n, e, o) {
                  ...
                  (l = v("<" + r + "/>")
                      ...
                      .addClass(
                          o ? this.c.dom.splitDropdownButton.className : ""
                      )
                      .attr("tabindex", this.s.dt.settings()[0].iTabIndex)
                      .attr("aria-controls", this.s.dt.table().node().id)
                      .on("click.dtb", function (t) {
                          t.preventDefault(),
                              !l.hasClass(u.disabled) &&
                                  n.action &&
                                  s(t, h, l, n),
                              a && l.trigger("blur");
                      })
        ...
        _resolveExtends: function (e) {
            ...
            for (e = t(e); e && e.extend; ) {
                ...
                if (u) {
                    for (
                        e.buttons || (e.buttons = []), n = 0, o = u.length;
                        n < o;
                        n++
                    )
        ...
        _popover: function (o, t, n, e) {
            ...
            !1 === o
                ...
                : ((p = v(
                      ...
                      (g.closest("div.dt-button-collection").length &&
                          (g = p.eq(0)),
                      i()),
                  ...
                  "absolute" === d
                      ? ((p = v(g[0].offsetParent)),
                        ...
                        n.left + u < 0 && (u = -n.left),
                        a.top + p + c.height >
                            v(m).height() + v(m).scrollTop() &&
                            (p =
                                t.top -
                                c.height -
                                c.marginTop -
                                c.marginBottom),
                        a.top + p < v(m).scrollTop() &&
                            (p = t.top + g.outerHeight()),
                        s.css({ top: p, left: u }))
                      : ((d = function () {
                            var t = v(m).height() / 2,
                ...
                var u = [],
                    ...
                    d = function (t, n) {
                        ...
                        if (Array.isArray(t) || t instanceof v)
                            ...
                            n.s.buttons[t] &&
                                u.push({ inst: n, node: n.s.buttons[t].node });
                        else if ("string" == typeof t)
                            if (-1 !== t.indexOf(","))
                                for (
                                    var i = t.split(","), s = 0, r = i.length;
                                    s < r;
                                    s++
                                )
                                    d(i[s].trim(), n);
        ...
        v.extend(w, {
            ...
            excel: function (t, n) {
                if (w.excelHtml5 && w.excelHtml5.available(t, n))
                    return "excelHtml5";
            },
            pdf: function (t, n) {
        ...
        e.Api.register("buttons()", function (n, e) {
            ...
            var t = this.iterator(
                ...
                function (t) {
                    if (t._buttons)
                        return k.buttonSelector(
                            k.instanceSelector(n, t._buttons),
                            e
                        );
                },
                !0
        ...
        e.Api.register("buttons().containers()", function () {
            ...
            return (
                this.iterator(!0, "table", function (t) {
                    if (t._buttons)
                        for (
                            var n = k.instanceSelector(s, t._buttons),
                                e = 0,
                                o = n.length;
                            e < o;
                            e++
        ...
        e.Api.register("button().add()", function (t, n, e) {
            ...
            return (
                o.length &&
                    (o = k.instanceSelector(this._groupSelector, o[0]._buttons))
                        .length &&
                    o[0].add(n, t, e),
                ...
                var o = v.extend(
                    ...
                    i =
                        (e.select &&
                            ...
                            i.selected === x &&
                            e
                                .rows(o.rows, v.extend({ selected: !0 }, i))
                                .any() &&
