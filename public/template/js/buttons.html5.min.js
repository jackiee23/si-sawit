...
!(function (n) {
    ...
    function N(t) {
        var e = "Sheet1";
        return (e = t.sheetName
            ? t.sheetName.replace(/[\[\]\*\/\\\?\:]/g, "")
            : e);
    }
    function u(t, e) {
        for (
    ...
    return (
        (n.ext.buttons.copyHtml5 = {
            className: "buttons-copy btn btn-danger",
            text: function (t) {
        ...
        (n.ext.buttons.csvHtml5 = {
            bom: !1,
            className: "buttons-csv btn btn-danger",
            available: function () {
        ...
        (n.ext.buttons.excelHtml5 = {
            className: "buttons-excel btn btn-danger",
            available: function () {
            ...
            action: function (t, e, o, s) {
                ...
                function n(t) {
                    ...
                    for (var e = 0, o = t.length; e < o; e++) {
                        ...
                        var r = t[e];
                        t[e] =
                            "function" == typeof t[e].trim ? t[e].trim() : t[e];
                ...
                var a,
                    ...
                    I =
                        (s.customizeData && s.customizeData(i),
                        e.buttons.exportInfo(s));
                I.title && (n([I.title]), r(y, i.header.length - 1)),
                    I.messageTop &&
                        (n([I.messageTop]), r(y, i.header.length - 1)),
                    s.header &&
                        (n(i.header), C("row:last c", u).attr("s", "2"));
                ...
                (a = y),
                    ...
                    I.messageBottom &&
                        (n([I.messageBottom]), r(y, i.header.length - 1));
                var b = E(u, "cols");
